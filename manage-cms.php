  ...
  $arr_file = explode('.', $_FILES['filename']['name']);
        ...
        if (!empty($sheetData)) {
          for ($i=1; $i<count($sheetData); $i++) {
              ...
              $checkBacklinks =$db->display('cms_details',' backlink="'.$url.'"');
            ...
            $masterBacklinks = $db->insert('cms_details',$data);
          }
      }
    }
...
if(isset($_POST['buttonDelete'])) {
	if(isset($_POST['backlinkIds'])) {
		foreach ($_POST['backlinkIds'] as $backlinkIds) {
			$db->delete('cms_details',"id=".$backlinkIds);
		}
	}
  header("location:manage-cms.php");
}
...
<head>
    ...
    <title>Conversions - Client Panel | Manage CMS</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-3">
                                        <a style="float:left" href="add-cms-info.php"
                                            class="btn btn-primary btn-sm">Add CMS</a>
                                        <a style="margin-left:5px;float:left" href="csv.php?cms=cms"
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $backlinks =$db->display('cms_details','is_deleted=0');
