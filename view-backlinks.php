        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Client Backlinks - <?php echo $clientData['company_name'];?></h1>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-3">
                                        ...
                                        <a style="float:left" href="csv.php?backlinks=backlinks"
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $backlinks =$db->display('backlinks',' client_id='.$clientData["id"].' and is_deleted=0');
                      ...
                      while($row = $backlinks->fetch_array()) {?>
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" class="chkCheckBoxId"
                                                            value="<?php echo $row['id']; ?>" name="backlinksIds[]" />
                                                    </td>
                                                    ...
                                                    <!-- <td>status</td> -->
                                                    <td><a href="javascript:void(0);" id="<?php echo $row['id'];?>"
                ...
                <div class="modal-content">
                    ...
                    if($clients->num_rows > 0){
                      while($clientData = $clients->fetch_array()) {?>
                                    <option <?php if($clientData['id']==$_GET["client_id"]){?> selected <?php }?>
                                        value="<?php echo $clientData['id']?>"><?php echo $clientData['website']?>
                                    </option>
                                    <?php }}?>
                                </select>
                            </div>
