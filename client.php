            ...
            <div class="card">
              ...
              <form method="post">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $clients =$db->display('clients','is_deleted=0');
                    if($clients->num_rows > 0){
                      while($row = $clients->fetch_array()) {?>
                  <tr>
                    <?php $countBacklinks =$db->display('backlinks', ' client_id='.$row["id"]); ?>
                    <td><input type="checkbox" class="chkCheckBoxId" value="<?php echo $row['id']; ?>" name="clientIds[]" /></td>
                    <td><a href="view-backlinks.php?client=<?=$row['company_name']?>"><?php echo $row['company_name'];?></a></td>
                    <td><?php echo $row['username'];?></td>
                    <td><?php echo $row['website'];?></td>
                    <td><?php echo $row['seo_phone'];?></td>
                    <td><?php echo $row['seo_landline'];?></td>
                    <td><?php echo $row['seo_email'];?></td>
                    <td><?php echo $row['seo_password'];?></td>
                    <td><a href="view-backlinks.php?client=<?=$row['company_name']?>"><?php echo $countBacklinks->num_rows ;?></a></td>
